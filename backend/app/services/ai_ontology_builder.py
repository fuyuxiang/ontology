...
_SCENARIO_PROMPT = """你是联通运营商业务本体建模助手。用户想要构建一个业务场景的本体模型。
...
_MATERIALS_PROMPT = """你是联通运营商本体建模助手。用户要构建「{scenario}」场景的本体。
...
_CLARIFY_PROMPT = """你是联通运营商本体建模助手。用户要构建「{scenario}」场景的本体，已提供以下材料。
...
_BUILD_PROMPT = """你是联通运营商本体建模专家。请基于以下业务材料和信息，自动构建完整的本体模型。
