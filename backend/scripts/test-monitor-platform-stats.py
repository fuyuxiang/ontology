...
def main() -> None:
    ...
    with engine.begin() as conn:
        ...
        conn.execute(text("CREATE TABLE quality_rules (id VARCHAR(36) PRIMARY KEY)"))
        conn.execute(text("INSERT INTO assets (id, status) VALUES ('a1', 'active'), ('a2', 'broken')"))
        conn.execute(text("INSERT INTO quality_rules (id) VALUES ('r1'), ('r2')"))
    ...
    print("monitor platform stats reads current asset and rule tables")
