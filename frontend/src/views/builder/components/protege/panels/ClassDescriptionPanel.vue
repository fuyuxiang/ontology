  ...
  <div>
    ...
    <div class="pg-panel">
      ...
      <div v-show="subOpen" class="pg-panel__body">
        ...
        <button class="pg-btn" style="margin-top:4px" @click="addSuperClass">+ 添加</button>
      </div>
    </div>
    ...
    <div class="pg-panel">
      ...
      <div v-show="eqOpen" class="pg-panel__body">
        ...
        <button class="pg-btn" style="margin-top:4px" @click="addEquivalent">+ 添加</button>
      </div>
    </div>
    ...
    <div class="pg-panel">
      ...
      <div v-show="djOpen" class="pg-panel__body">
        ...
        <button class="pg-btn" style="margin-top:4px" @click="addDisjoint">+ 添加</button>
      </div>
    </div>
  </div>
</template>
