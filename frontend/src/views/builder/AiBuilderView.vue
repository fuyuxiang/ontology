<template>
  <div class="ai-builder">
    ...
    <div class="ai-builder__content">
      ...
      <StepDomainDrill v-else-if="step === 1" :domain="selectedDomain" @next="onTablesSelected" />
...
function onDomainSelected(payload: { domain: string; businessDesc: string }) {
  selectedDomain.value = payload.domain
