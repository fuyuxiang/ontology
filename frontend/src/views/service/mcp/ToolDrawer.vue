...
.drawer { width: 520px; height: 100%; background: #fff; box-shadow: -4px 0 24px rgba(0,0,0,0.12); overflow-y: auto; animation: slideIn 0.2s ease-out; }
@keyframes slideIn { from { transform: translateX(100%); } to { transform: translateX(0); } }
.drawer__header { display: flex; justify-content: space-between; align-items: center; padding: 20px 24px; border-bottom: 1px solid var(--neutral-200); position: sticky; top: 0; background: #fff; z-index: 1; }
.drawer__header h3 { font-size: 14px; font-weight: 700; color: var(--neutral-900); margin: 0; font-family: monospace; }
.close-btn { background: none; border: none; font-size: 20px; color: var(--neutral-400); cursor: pointer; }
.close-btn:hover { color: var(--neutral-700); }
.drawer__body { padding: 20px 24px; }
.drawer__desc { font-size: 13px; color: var(--neutral-600); margin: 0 0 20px; }
.drawer__body h4 { font-size: 13px; font-weight: 600; color: var(--neutral-800); margin: 20px 0 10px; }
