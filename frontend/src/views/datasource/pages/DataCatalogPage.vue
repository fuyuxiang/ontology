<template>
  <div class="di-page">
    <div class="di-page__header">
      <h1 class="di-page__title">数据目录</h1>
      <p class="di-page__subtitle">浏览数据集 · 关联本体对象 · 查看负责人与覆盖度</p>
    </div>
    <DataCatalogTab />
  </div>
</template>
...
<style scoped>
.di-page { padding: var(--space-8) var(--space-8); }
.di-page__header { margin-bottom: var(--space-5); }
.di-page__title {
