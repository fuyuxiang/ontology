...
const moduleCards = computed<ModuleCard[]>(() => {
  ...
  return [
    ...
    },
    {
      ...
      route: '/service/agent', secondaryRoute: '/data/ingest',
      primaryLabel: '打开智能对话', secondaryLabel: '查看数据接入',
    ...
    },
    {
      ...
      route: '/data/ingest', secondaryRoute: '/browser',
      primaryLabel: '打开数据接入', secondaryLabel: '查看本体浏览器',
